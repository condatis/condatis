...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.registerButton, 1, 1, 1, 1)
        ...
        self.webView.setProperty("url", QtCore.QUrl(_fromUtf8("http://localhost/condatis/form.html")))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_3.setText(_translate("Dialog", "Please take a moment to register Condatis. Use the web form on the right to send your details. You will be sent an email with a registration code. Type this in to the box below and press \'Regsiter\'.", None))
